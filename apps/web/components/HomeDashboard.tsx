      ...
      {showSortSheet && (
        ...
        >
          ...
          >
            ...
            <p style={{ margin:'0 0 14px 8px', fontSize:11, fontWeight:700, letterSpacing:1.5, textTransform:'uppercase', color: theme.colors.muted }}>Sort by</p>
            {([
              ...
              { id: 'most-photos'   as MonthSort, label: 'Most Photos',    sub: 'Months with most items first',   icon: '📸' },
